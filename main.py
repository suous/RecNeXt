...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'recnext training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=256, type=int)
    parser.add_argument('--epochs', default=300, type=int)

    # Model parameters
    parser.add_argument('--model', default='recnext_m1', type=str, metavar='MODEL',
    ...
    parser.add_argument('--project', default='recnext', type=str)
    return parser
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'recnext training and evaluation script', parents=[get_args_parser()])
