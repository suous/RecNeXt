...
def recnext_a4(pretrained=False, **kwargs):
    model_args = dict(embed_dim=(64, 128, 256, 512), depth=(5, 5, 25, 4), mlp_ratio=1.875, drop_path_rate=0.2)
    return _create_recnext("recnext_a4", pretrained=pretrained, **dict(model_args, **kwargs))

@register_model
def recnext_a5(pretrained=False, **kwargs):
    model_args = dict(embed_dim=(80, 160, 320, 640), depth=(7, 7, 35, 2), mlp_ratio=1.875, drop_path_rate=0.3)
