...
def get_args_parser():
    parser = argparse.ArgumentParser('recnext fused model evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=256, type=int)

    # Model parameters
    parser.add_argument('--model', default='recnext_m1', type=str, metavar='MODEL', help='Name of model to train')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('recnext fused model evaluation script', parents=[get_args_parser()])
